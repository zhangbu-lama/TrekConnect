    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-sky-100">
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Nepal offers some of the world's most spectacular trekking routes, from the iconic Everest Base Camp to
              the diverse landscapes of the Annapurna Circuit.
            </p>
          </div>
        ...
        <section className="bg-gradient-to-r from-sky-100 to-emerald-50 rounded-xl shadow-lg p-8 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-4 bg-white/70 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-sky-700 mb-2">Majestic Mountains</h3>
              <p className="text-gray-600">
                Home to eight of the world's fourteen highest peaks, including Mount Everest.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-4 bg-white/70 rounded-lg shadow-sm">
              <div className="bg-emerald-100 p-4 rounded-full mb-4 shadow-inner">
              ...
              <h3 className="text-xl font-semibold text-sky-700 mb-2">Diverse Landscapes</h3>
              <p className="text-gray-600">
                Trek through subtropical forests, alpine meadows, and high-altitude deserts.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-4 bg-white/70 rounded-lg shadow-sm">
              <div className="bg-emerald-100 p-4 rounded-full mb-4 shadow-inner">
              ...
              <h3 className="text-xl font-semibold text-sky-700 mb-2">Rich Culture</h3>
              <p className="text-gray-600">Experience the unique cultures and traditions of mountain communities.</p>
            </div>
          </div>
        </section>
      ...
      <footer className="bg-gradient-to-r from-sky-800 to-sky-700 text-white py-12 px-4 relative">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
          <div>
            <p className="text-sky-100 mt-8">Providing unforgettable trekking experiences in the Himalayas since 2005.</p>
          </div>
          <div className="mt-8">
          ...
          <div>
            <ul className="space-y-2 mt-5">
              <li>
                <Link href="/about" className="text-sky-100 hover:text-emerald-300 transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/tours" className="text-sky-100 hover:text-emerald-300 transition-colors">
                  Tours
                </Link>
              </li>
              <li>
                <Link href="/blog" className="text-sky-100 hover:text-emerald-300 transition-colors">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-sky-100 hover:text-emerald-300 transition-colors">
                  FAQs
                </Link>
              </li>
            </ul>
        ...
        <div className="max-w-7xl mx-auto mt-8 pt-8 border-t border-sky-600 text-center text-sky-200">
          <p>&copy; {new Date().getFullYear()} Nepal Trekking Adventures. All rights reserved.</p>
        </div>
      </footer>
    </div>
